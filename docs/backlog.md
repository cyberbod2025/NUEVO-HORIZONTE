...
Piloto vertical del contrato pedagógico de lección completado y probado: ver `docs/adr/0004-lesson-v2-pedagogical-contract.md`. Define `LessonV2`/`NormalizedLesson`, un adaptador que normaliza los 12 módulos v1 existentes sin migrarlos, y ahora **24 lecciones v2 reales** que cubren el territorio de los módulos 1 a 8: fundamentos, JavaScript moderno/async, Git/Conventional Commits, TypeScript, React, backend HTTP/Express/CRUD, bases de datos SQL/relaciones/Supabase RLS y pruebas automatizadas con AAA, casos límite, mocks/RTL. Todas incluyen práctica guiada de varios pasos, pistas progresivas y feedback por check individual. D-005 fija que los módulos 9–12 se migran antes de abrir Supabase; autenticación, mentor IA y Sandpack siguen fuera de alcance. Los ejemplos de Vitest/RTL son curriculares y los retos ejecutables usan solo JS local, sin red ni render React real. Pendiente inmediato: migrar el módulo 9 en una rama corta.
