...
Piloto vertical del contrato pedagógico de lección completado y probado: ver `docs/adr/0004-lesson-v2-pedagogical-contract.md`. Define `LessonV2`/`NormalizedLesson`, un adaptador que normaliza los 12 módulos v1 existentes sin migrarlos, y ahora **21 lecciones v2 reales** que cubren el territorio de los módulos 1 a 7: fundamentos, JavaScript moderno/async, Git/Conventional Commits, TypeScript, React, backend HTTP/Express/CRUD y bases de datos SQL/relaciones/Supabase RLS. Todas incluyen práctica guiada de varios pasos, pistas progresivas y feedback por check individual. D-005 fija que los módulos 8–12 se migran antes de abrir Supabase; autenticación, mentor IA y Sandpack siguen fuera de alcance. El contenido del módulo 7 enseña el concepto de Supabase/RLS de forma simulada — no abre el frente real de infraestructura. Pendiente inmediato: migrar el módulo 8 en una rama corta.
