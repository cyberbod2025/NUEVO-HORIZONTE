...
Piloto vertical del contrato pedagógico de lección completado y probado: ver `docs/adr/0004-lesson-v2-pedagogical-contract.md`. Define `LessonV2`/`NormalizedLesson`, un adaptador que normaliza los 12 módulos v1 existentes sin migrarlos, y ahora **27 lecciones v2 reales** que cubren el territorio de los módulos 1 a 9. D-005 fija que los módulos 10–12 se migran antes de abrir Supabase; autenticación, mentor IA, credenciales y peticiones LLM reales siguen fuera de alcance. El módulo 9 enseña prompts, RAG y límites de API con JS local, sin proveedor ni red. Pendiente inmediato: migrar el módulo 10 en una rama corta.
